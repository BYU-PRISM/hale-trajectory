...
def findSteadyState(x0,h_0,v_0,smartsData,config_file,swarm):
    '''
...
#    minimizer_kwargs = {"method": "L-BFGS-B","args":(v_0,h_0,smartsData,config_file)}
#    ret = basinhopping(pso_root, x0, minimizer_kwargs=minimizer_kwargs, niter=300,disp=True)
...
#    minimizer_kwargs = {"method": "SLSQP","args":(h_0,smartsData,config_file),"bounds":bounds,"constraints":cons}
#    ret = basinhopping(new_objective, x0v0, minimizer_kwargs=minimizer_kwargs, niter=100)
...
#                   options={'disp':True,'eps':1e-8,'ftol':1e-8})
    if(sol.success==False):
        ...
        minimizer_kwargs = {"method": "SLSQP","args":(h_0,smartsData,config_file),"bounds":bounds,"constraints":cons,"options":options}
        sol = basinhopping(new_objective, x0v0, minimizer_kwargs=minimizer_kwargs, niter=2000, niter_success=20)
...
#                  config_file['trajectory']['alpha']['max'],
#                  config_file['trajectory']['phi']['max']]
#            x0, fopt = pso(pso_root, lb=lb, ub=ub, args=(v_0,h_0,smartsData,config_file),maxiter=1500,swarmsize=3500)
#            print('Residual: ' + str(fopt))
#            print('New Guess Values: ' +str(x0))
#            cons = ({'type': 'ineq', 'fun':power_constraints,'args':(x0,h_0,smartsData,config_file)})
#        
