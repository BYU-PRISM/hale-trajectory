...
def getAtmosphere(alt):
	"""
	Returns computed temperature, density, and pressure in standard atmosphere.
    Correct to 86 km.  Only approximate thereafter.
    Input:
    ...
    pressure (N/m^2)
    temperature (K)
	viscosity (10^-6 kg/m-s)
	kinematicViscosity (m^2/s)
    """
	(sigma, delta, theta) = Atmosphere(alt/1000)
	...
	return density,pressure,temperature,viscosity,kinematicViscosity
