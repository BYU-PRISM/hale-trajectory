...
if option=='1' : # Default values
    ...
    n = 3
    distance = 3000
    horizon_length = int(25*n*2) # 10 minutes
    battery_mass = 240#139.5
    total_mass = 725#355.5#352.5
    ...
    gamma_factor = 2
    use_sm = 0
    description = 'Helios Extended Horizon'
...
config = dict(
    trajectory = dict(
        ...
        gamma = dict(
            ...
            initial_value = 0,
            up = 0.033/gamma_factor,
            level = 0,
            down = -0.026/gamma_factor,
            mode = 'level',
            units = 'radians',
        ...
        tp = dict(
            ...
            dcost = tp_dcost,
            ss_initial_guess = 190,
            initial_value = 190, # Opt initial value for first timestep. This will be updated after the SS code is run
            units = 'Newtons',
            description = 'Thrust',
            ),
        alpha = dict(
            ...
            dmax = alpha_dmax,
            dcost = alpha_dcost,
            ss_initial_guess = 0.21,
            initial_value = 0.21, # Opt initial value for first timestep. This will be updated after the SS code is run            
            units = 'radians',
...
#%% Import yaml file and access data from it
